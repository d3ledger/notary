...
class ContractsTest {
    ...
    fun differentVRS() {
        ...
        val finalHash = hashToWithdraw(token.contractAddress, amount.toString(), accGreen, defaultIrohaHash, relay.contractAddress)
    ...
    fun validSignatures3of5() {
        ...
        val finalHash =
            hashToWithdraw(
                ...
                amountToSend.toString(),
                accGreen,
                defaultIrohaHash,relay.contractAddress
            )
