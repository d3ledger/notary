...
object D3TestContext {
    val d3neededAccounts = listOf<AccountPrototype>(
        ...
        AccountPrototype("eth_token_storage_service", "notary", listOf("eth_token_list_storage")),
        AccountPrototype("withdrawal", "notary", listOf("withdrawal")),
        AccountPrototype("btc_fee_rate", "notary", listOf("btc_fee_rate_setter")),
        AccountPrototype("btc_withdrawal_service", "notary", listOf("withdrawal", "rollback")),
        AccountPrototype("btc_sign_collector", "notary", listOf("signature_collector")),
        AccountPrototype("test", "notary", listOf("tester", "registration_service", "client")),
        AccountPrototype("vacuumer", "notary", listOf("vacuumer")),
        PassiveAccountPrototype("notaries", "notary", listOf("notary_list_holder")),
